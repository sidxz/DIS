...
The API is now available at http://localhost:8001. Interactive docs at http://localhost:8001/docs.
...
3. Set redirect URI: `http://localhost:8001/auth/callback/google`
...
3. Set callback URL: `http://localhost:8001/auth/callback/github`
...
3. Set redirect URI: `http://localhost:8001/auth/callback/entra_id`
