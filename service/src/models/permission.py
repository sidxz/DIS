...
class ResourcePermission(Base):
    ...
    __table_args__ = (
        UniqueConstraint("service_name", "resource_type", "resource_id", name="uq_resource_identity"),
        ...
        Index("ix_resource_permissions_lookup", "service_name", "resource_type", "resource_id"),
    )
    ...
    visibility: Mapped[str] = mapped_column(Text, nullable=False, server_default="workspace")
    created_at: Mapped[datetime] = mapped_column(DateTime(timezone=True), server_default=func.now())

    shares: Mapped[list["ResourceShare"]] = relationship(back_populates="resource_permission", cascade="all, delete-orphan")


class ResourceShare(Base):
    __tablename__ = "resource_shares"
    __table_args__ = (
        UniqueConstraint("resource_permission_id", "grantee_type", "grantee_id", name="uq_resource_share"),
    ...
    resource_permission: Mapped["ResourcePermission"] = relationship(back_populates="shares")
